...
public class LockSettingsService extends ILockSettings.Stub {
    ...
    private void disableEscrowTokenOnNonManagedDevicesIfNeeded(int userId) {
        ...
        try {
            ...
            // Escrow tokens are enabled for this builds.
            if (mContext.getPackageManager().hasSystemFeature(PackageManager.FEATURE_ACCEPT_ESCROW_TOKENS)) {
                Slog.i(TAG, "Feature enabled.");
                return;
            }
